                                            ...
                                            <form action="{{ route('update.review') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <textarea name="message" class="form-control" rows="3">{{ old('message', $review->message) }}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <img src="{{ !empty($review->image) ? asset($review->image) : asset('upload/no_image.jpg') }}"
                                                            id="showImage"
