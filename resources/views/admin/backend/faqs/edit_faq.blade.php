                                            ...
                                            <form action="{{ route('update.faqs') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="question" class="form-control" value="{{ old('question', $faqs->question) }}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Answer</label>
                                                        <div class="input-group">
                                                            <textarea name="answer" class="form-control" rows="3">{{ old('answer', $faqs->answer) }}</textarea>
                                                        </div>
                                                    </div>
